...
Example:
    Save visualizations and predictions results::
        ...
        /home/yp/4T/wzp/mmdetection_远程/data_all/coco/val2017/00005.bmp
        /home/yp/4T/wzp/mmdetection_远程/configs/swin/Faster-Rcnn_cross_attention.py
        --weights /home/yp/4T/wzp/mmdetection_远程/work_dirs/Faster-rcnn_cross_attention/epoch_14.pth
...
def parse_args():
    ...
    parser.add_argument(
        '--inputs', default='/home/yp/4T/wzp/mmdetection_远程/data_all/coco/val2017/01302.bmp', help='Input image file or folder path.')
    parser.add_argument(
        '--model',
        type=str,
        default='/home/yp/4T/wzp/mmdetection_远程/configs/swin/Faster-Rcnn_cross_attention.py',
        help='Config or checkpoint .pth file or the model name '
        'and alias defined in metafile. The model configuration '
        'file will try to read from .pth if the parameter is '
        'a .pth weights file.')
    parser.add_argument('--weights', default='/home/yp/4T/wzp/mmdetection_远程/work_dirs/weights/epoch_6.pth', help='Checkpoint file')
    parser.add_argument(
        '--out-dir',
        type=str,
        default='/home/yp/4T/wzp/mmdetection_远程/outputs/',
