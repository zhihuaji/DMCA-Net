...
num_classes = 1203
lvis_cat_frequency_info = 'data_true/metadata/lvis_v1_train_cat_info.json'

# 'data_true/metadata/lvis_v1_clip_a+cname.npy' is pre-computed
# CLIP embeddings for each category
cls_layer = dict(
    type='ZeroShotClassifier',
    zs_weight_path='data_true/metadata/lvis_v1_clip_a+cname.npy',
    zs_weight_dim=512,
    use_bias=0.0,
    norm_weight=True,
...
val_evaluator = dict(
    type='LVISMetric',
    ann_file='data_true/lvis/annotations/lvis_v1_val.json',
    metric=['bbox', 'segm'])
