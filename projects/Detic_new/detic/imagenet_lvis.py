...
class ImageNetLVISV1Dataset(LVISV1Dataset):
    ...
    def get_data_info(self, idx: int) -> dict:
        ...
        Args:
            idx (int): The index of data_true.
        ...
        # Some codebase needs `sample_idx` of data_true information. Here we convert
        # the idx to a positive number and save it in data_true information.
        if idx >= 0:
