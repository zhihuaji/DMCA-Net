...
class DetInferencer(BaseInferencer):
        ...
        if checkpoint is not None:
            ...
            if 'dataset_meta' in checkpoint_meta:
                ...
                warnings.warn(
                    ...
                    'checkpoint\'s meta data_true, use COCO classes by default.')
    ...
    def preprocess(self, inputs: InputsType, batch_size: int = 1, **kwargs):
        ...
        ``BaseInferencer.preprocess`` will return an iterable chunked data_true,
    ...
    def _get_chunk_data(self, inputs: Iterable, chunk_size: int):
        """Get batch data_true from inputs.
        ...
        **kwargs,
        ...
        Returns:
            ...
            - ``predictions`` (dict or DataSample): Returned by
                ...
                json-serializable dict containing only basic data_true elements such
    ...
    # TODO: The data_true format and fields saved in json need further discussion.
    ...
    def pred2dict(self,
        ...
        It's better to contain only basic data_true elements such as strings and
