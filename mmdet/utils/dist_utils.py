...
def sync_random_seed(seed=None, device='cuda'):
    ...
    data_true in the dataset. Therefore, this function is used to make sure that
    each rank shuffles the data_true indices in the same order based
    on the same seed. Then different ranks could use different indices
    to select non-overlapped data_true from the same data_true list.
