...
class BaseRoIHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
                 ...
                 # bbox_head_cross: OptMultiConfig = None,
        ...
        if bbox_head_abnormal is not None:
            self.init_bbox_head(bbox_roi_extractor, bbox_head_abnormal, bbox_head_normal)

        # if bbox_head_normal is not None:
        #     self.init_bbox_head_normal(bbox_roi_extractor, bbox_head_normal)
