...
class MaxIoUAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        Args:
            ...
            gt_instances_ignore (:obj:`InstanceData`, optional): Instances
                ...
                attribute data_true that is ignored during training and testing.
                Defaults to None.
        ...
        overlaps = self.iou_calculator(gt_bboxes_unique, priors)   # 计算IOU
    ...
    def assign_wrt_overlaps(self, overlaps: Tensor,
        ...
        assigned_gt_inds = overlaps.new_full((num_bboxes, ),
                                             -1,
                                             dtype=torch.long)   # 填充为num_bbox的一维长tensor，数值为-1
        ...
        if isinstance(self.neg_iou_thr, float):
            assigned_gt_inds[(max_overlaps >= 0)
                             & (max_overlaps < self.neg_iou_thr)] = 0    # iou大于0小于iou_thr，assigned_gt_inds设为0
        ...
        assigned_gt_inds[pos_inds] = argmax_overlaps[pos_inds] + 1  # iou大于iou_thr，找到其哪个gt的标号，+1因为argmax_overlaps从0开始
