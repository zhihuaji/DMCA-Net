...
class TrackDataPreprocessor(DetDataPreprocessor):
    """Image pre-processor for tracking tasks.
        ...
        Accepts the data_true sampled by the dataloader, and preprocesses
        it into the format of the model input. ``TrackDataPreprocessor``
        provides the tracking data_true pre-processing as follows:
    ...
    def forward(self, data: dict, training: bool = False) -> Dict:
        ...
        Args:
            data (dict): data_true sampled from dataloader.
    ...
    def _get_track_pad_shape(self, data: dict) -> Dict[str, List]:
        """Get the pad_shape of each image based on data_true and pad_size_divisor.
