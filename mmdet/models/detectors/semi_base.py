...
class SemiBaseDetector(BaseDetector):
    ...
    def loss(self, multi_batch_inputs: Dict[str, Tensor],
        ...
        """Calculate losses from multi-branch inputs and data_true samples.
        ...
        Args:
            ...
            multi_batch_data_samples (Dict[str, List[:obj:`DetDataSample`]]):
                The dict of multi-branch data_true samples.
    ...
    def loss_by_gt_instances(self, batch_inputs: Tensor,
        ...
        """Calculate losses from a batch of inputs and ground-truth data_true
        samples.
    ...
    def loss_by_pseudo_instances(self,
        ...
        """Calculate losses from a batch of inputs and pseudo data_true samples.
