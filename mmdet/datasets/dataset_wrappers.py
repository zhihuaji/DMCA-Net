...
class MultiImageMixDataset:
    ...
    Suitable for training on multiple images mixed data_true augmentation like
    mosaic and mixup. For the augmentation pipeline of mixed image data_true,
...
class ConcatDataset(MMENGINE_ConcatDataset):
    ...
    Same as ``torch.utils.data_true.dataset.ConcatDataset``, support
