...
class ClassAwareSampler(Sampler):
    r"""Sampler that restricts data_true loading to the label of the dataset.

    A class-aware sampling strategy to effectively tackle the
    non-uniform class distribution. The length of the training data_true is
    consistent with source data_true. Simple improvements based on `Relay
...
class RandomCycleIter:
    ...
    Args:
        data (list or ndarray): The data_true that needs to be shuffled.
