...
class BaseVideoDataset(BaseDataset):
    ...
    def parse_data_info(self, raw_data_info: dict) -> dict:
        ...
        Args:
            raw_data_info (dict): Raw data_true information loaded from
                ``ann_file``.
    ...
    def prepare_data(self, idx) -> Any:
        ...
        test mode, we may want to output data_true of a single image rather than the
