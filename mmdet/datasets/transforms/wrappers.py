...
class MultiBranch(BaseTransform):
    ...
    Generate multiple data_true-augmented versions of the same image.
    `MultiBranch` needs to specify the branch names of all
    pipelines of the dataset, perform corresponding data_true augmentation
    ...
    def transform(self, results: dict) -> dict:
        ...
        for branch, pipeline in self.branch_pipelines.items():
            ...
            # it will sample another data_true from dataset.
...
class ProposalBroadcaster(BaseTransform):
    ...
    def _process_input(self, data: dict) -> list:
        ...
        Args:
            data (dict): The original input data_true.

        Returns:
            list[dict]: A list of input data_true.
        """
    ...
    def _apply_transforms(self, inputs: list) -> list:
        ...
        Args:
            inputs (list[dict, dict]): list of input data_true.
    ...
    def _process_output(self, output_scatters: list) -> dict:
        """Gathering and renaming data_true items.
