...
class RandomAffine(BaseTransform):
    """Random affine transform data_true augmentation.
...
class YOLOXHSVRandomAug(BaseTransform):
    ...
    BaseDetection/YOLOX/blob/main/yolox/data_true/data_augment.py#L21.
...
class CachedMixUp(BaseTransform):
    """Cached mixup data_true augmentation.
