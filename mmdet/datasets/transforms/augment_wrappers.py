...
# some widely useful data_true augmentation strategies,
...
# RandAugment defines a data_true augmentation search space, RANDAUG_SPACE,
# sampling 1~3 data_true augmentations each time, and
# setting the magnitude of each data_true augmentation randomly,
...
class AutoAugment(RandomChoice):
    ...
    This data_true augmentation is proposed in `AutoAugment: Learning
...
class RandAugment(RandomChoice):
    ...
    This data_true augmentation is proposed in `RandAugment:
    Practical automated data_true augmentation with a reduced
