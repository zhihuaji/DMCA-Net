...
if __name__ == '__main__':
    convert_balloon_to_coco(ann_file='data_true/balloon/train/via_region_data.json',
                            out_file='data_true/balloon/train/annotation_coco.json',
                            image_prefix='data_true/balloon/train')
    convert_balloon_to_coco(ann_file='data_true/balloon/val/via_region_data.json',
                            out_file='data_true/balloon/val/annotation_coco.json',
                            image_prefix='data_true/balloon/val')
```
